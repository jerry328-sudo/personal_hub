/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: b8afa7ead87731e4db3b65ead427369d)
// Runtime types generated with workerd@1.20260917.1 2026-09-18 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	MEDIA: R2Bucket;
	DB: D1Database;
	LOGIN_RATE_LIMITER: RateLimit;
	READER_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	APP_ORIGIN: "https://personal-hub.echem.ai" | "http://localhost:5173";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "SESSION_TTL_SECONDS" | "ADMIN_LOGIN_SECRET" | "AUTH_PEPPER">> {}
}
